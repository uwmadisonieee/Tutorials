/*
 * Compile:
 *        g++ -fopenmp -std=c++11 monteCarlo.cpp -o monteCarlo
 */
...
void parallelPi()
{
    ...
    const int numTotalSamples = SAMPLE_N;
    int numChunks = sysconf(_SC_NPROCESSORS_ONLN);;
